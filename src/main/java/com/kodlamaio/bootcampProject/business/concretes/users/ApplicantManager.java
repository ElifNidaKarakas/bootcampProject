...
public class ApplicantManager implements ApplicantService {
	...
	public DataResult<List<GetAllApplicantResponse>> getAll() {
		...
		return new SuccessDataResult<List<GetAllApplicantResponse>>(applicantResponses, Messages.ApplicantListed);
	}
	...
	public DataResult<CreateApplicantResponse> add(CreateApplicantRequest createApplicantRequest) {
		...
		return new SuccessDataResult<CreateApplicantResponse>(applicantResponse, Messages.ApplicantCreate);
	}
	...
	public DataResult<UpdateApplicantResponse> update(UpdateApplicantRequest updateApplicantRequest) {
		...
		return new SuccessDataResult<UpdateApplicantResponse>(applicantResponse, Messages.ApplicantUpdate);
	}
